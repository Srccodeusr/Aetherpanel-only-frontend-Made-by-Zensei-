  ...
  const handleDiscordSignIn = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setError(res.message || 'Discord authentication failed.');
      }
    } catch (err: any) {
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-white font-sans">
            Sign In to {brandName || 'Your Account'}
          </h2>
          <p className="text-xs text-zinc-400">
            Access your dashboard, orders, and account settings.
          </p>
        </div>
            ...
            <div className="space-y-3">
              ...
              {authConfig.discordEnabled && (
                ...
                >
                  ...
                  <span>{discordLoading ? 'Authorizing Discord...' : 'Continue with Discord'}</span>
                </button>
              )}
            </div>
          )}
          ...
          {hasSocialAuth && isEmailEnabled && (
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-semibold">
                <span className="bg-zinc-900 px-3 text-zinc-500">Or with email credentials</span>
              </div>
            </div>
          )}
          ...
          {isEmailEnabled ? (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="admin@yourdomain.com or username"
            ...
            !hasSocialAuth && (
              <div className="text-center text-xs text-zinc-400 py-4">
                Authentication methods are currently disabled by administrator.
              </div>
            )
          )}
